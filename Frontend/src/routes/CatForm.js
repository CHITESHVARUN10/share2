      ...
      <div className="d-form2">
        ...
        <div className="p1">
          <form onSubmit={handleSubmit}>
            ...
            <TextField label="FVRCP" variant="standard" required />
            ...
            <FormGroup>
              ...
              <FormControlLabel
                control={<Checkbox />}
                label="Tested positive for FeLV or FIV"
              />
            ...
            <FormControl>
              <FormLabel id="demo-radio-buttons-group-label" required>
                {" "}
                Are you willing to commit your pet to at least four donations
                per year? :
              </FormLabel>
              <RadioGroup
                aria-labelledby="demo-radio-buttons-group-label"
            ...
            <FormControl>
              <FormLabel id="demo-radio-buttons-group-label" required>
                {" "}
                Are you comfortable with a 2-4 area of hair being shaved from
                your pet's neck at each donation?
              </FormLabel>
              <RadioGroup
                aria-labelledby="demo-radio-buttons-group-label"
                defaultValue="Yes"
            ...
            <FormControl>
              <FormLabel id="demo-radio-buttons-group-label" required>
                {" "}
                Are you comfortable with sedation and/or anesthesia for your
                pet's donation?
              </FormLabel>
              <RadioGroup
                aria-labelledby="demo-radio-buttons-group-label"
